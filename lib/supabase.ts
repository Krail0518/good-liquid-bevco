...
export type Client = { id: string; name: string; contact_name: string; email: string; phone: string; service: string; status: string; total_billed: number; initials: string; color: string; tc: string; notes: string }
