...
(function(){
  ...
  var RC = {
    canning: {
      ...
      tiers: [
        {min:200,  max:339,  cs:{s:11.52,sl:11.52,x:13.92}, cn:{s:0.48,sl:0.48,x:0.58}},
  ...
  window.glExportPDF = function(){
    ...
    var html='<!DOCTYPE html><html><head><meta charset="UTF-8"><link rel="stylesheet" href="' + location.origin + '/gl-print-invoice.css"></head><body>'+
