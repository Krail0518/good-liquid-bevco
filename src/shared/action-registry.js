...
(function () {
  ...
  window.glRegisterGlobalActions([
    ...
    'glPortalPickProject',
    'glPortalRequestService',
    'glPortalTab',
    'glPortalUploadAgreement',
    'glProjectCreate',
    'glProjectEditDetails',
    'glProjectPreviewAsClient',
    'glMilestoneSetTarget',
    'glMilestoneSetOwner',
    'glMilestoneNewRound',
    'glProjectSetArchived',
    'glProjectSetStatus',
    'glProjectToggleService',
    'glPwSubmitEnter',
    'glPwUserEnter',
    'glQuoteFromDeal',
    'glReloadPage',
