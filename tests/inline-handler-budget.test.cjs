...
const BUDGET = {
  ...
  'src/shared/tools.js': 4,
  'src/modules/customers/portal-customer.js': 3,
  'src/modules/pipeline/referrals.js': 4,
  'src/modules/customers/edit-client.js': 1,
  'src/modules/invoicing/invoice-patches.js': 3,
  'src/shared/ai-hub.js': 3,
  'src/modules/customers/artwork.js': 2,
  'src/modules/customers/client-detail.js': 2,
  'src/modules/customers/tags.js': 2,
  'src/modules/pipeline/deal-docs.js': 2,
  'src/modules/production/gmp.js': 2,
  'src/modules/production/production-runs.js': 0,
  'src/modules/production/trace.js': 2,
  'src/shared/admin-tools.js': 2,
  ...
  'src/modules/pipeline/scheduling.js': 1,
  'src/modules/production/compliance.js': 1,
  'src/modules/production/gmp-schedule.js': 1,
  'src/modules/production/tour-booking.js': 1,
  'src/shared/calendar.js': 1,
  'src/shared/public-ops.js': 1,
};
