...
const BUDGET = {
  'index.html': 234,
  'crm-index-core.js': 73,
  'src/modules/invoicing/invoice-patches.js': 23,
  'src/modules/invoicing/invoice-builder.js': 22,
  'src/services/permissions-service.js': 17,
  'src/modules/pipeline/referrals.js': 16,
  'src/modules/customers/portal-customer.js': 12,
  'src/modules/production/trace.js': 12,
  'src/shared/admin-tools.js': 12,
  'src/modules/production/gmp.js': 10,
  'src/modules/production/audit-review.js': 8,
  'src/shared/tools.js': 8,
  'src/modules/production/compliance.js': 7,
  'src/modules/customers/requests.js': 6,
  'src/modules/pipeline/scheduling.js': 6,
  'src/shared/calendar.js': 5,
  'src/modules/customers/client-notes.js': 4,
  'src/modules/customers/email-templates.js': 4,
  'src/modules/customers/tags.js': 4,
  'src/modules/production/production-runs.js': 4,
  'src/shared/ai-hub.js': 4,
  'src/shared/correspondence.js': 4,
  'src/shared/public-ops.js': 4,
  'src/modules/customers/edit-client.js': 3,
  'src/modules/customers/onboarding.js': 3,
  'src/modules/invoicing/ar-aging.js': 3,
  'src/modules/invoicing/pay-link.js': 3,
  'src/modules/production/time-tracking.js': 3,
  'src/modules/production/tour-booking.js': 3,
  'src/modules/production/training.js': 3,
